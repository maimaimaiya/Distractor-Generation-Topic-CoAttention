...
from onmt.distractor.attention import HierarchicalAttention,CQAttention
...
class HierDecoder(nn.Module):
    ...
    """
    def __init__(self, dec_topic_embeddings,rnn_type,
        ...
        self.topic_emb = dec_topic_embeddings
        self.dropout = nn.Dropout(dropout)

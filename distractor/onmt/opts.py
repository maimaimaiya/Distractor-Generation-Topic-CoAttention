...
def model_opts(parser):
    ...
    group.add_argument('-word_encoder_layers', type=int, default=2,
                       help='Number of layers in the encoder')
    group.add_argument('-sent_encoder_type', type=str, default='brnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                       help="""hierarchical layer sent encode type""")
    group.add_argument('-sent_encoder_layers', type=int, default=2,
                       help='Number of layers in the encoder')
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_dir', default = '/data/home/shuaipengju/distractor_code_coattention/data/race_train.json',#required=True,
                       help="Path to the training data")
    group.add_argument('-valid_dir', default = '/data/home/shuaipengju/distractor_code_coattention/data/race_dev.json',#required=True,
                       help="Path to the validation data")
    group.add_argument('-data_type', choices=["text"], help="""text""")
    group.add_argument('-save_data', default = '/data/home/shuaipengju/distractor_code_coattention/data/processed',#required=True,
    ...
    group.add_argument('-src_seq_length', type=int, default=60,
                       help="Maximum source sequence length")
    group.add_argument('-src_sent_length', type=int, default=40,
                       help="Maximum source sequence length")
    ...
    group.add_argument('-shuffle', type=int, default=1,
                       help="Shuffle data")
    group.add_argument('-seed', type=int, default=1995,
                       help="Random seed")

    group = parser.add_argument_group('Logging')
    group.add_argument('-report_every', type=int, default=300,
...
def train_opts(parser):
    ...
    group.add_argument('-data',default = '/data/home/shuaipengju/distractor_code_coattention/data/processed',# required=True,
                       help="""Path prefix to the ".train.pt" and
                       ".valid.pt" file path from preprocess.py""")

    group.add_argument('-save_model', default='/data/home/shuaipengju/distractor_code_coattention/data/model/temp_model',
                       help="""Model filename (the model will be saved as
                       <save_model>_N.pt where N is the number
                       of steps""")

    group.add_argument('-save_checkpoint_steps', type=int, default=3000,
    ...
    group.add_argument('-pre_word_vecs_enc',default = '/data/home/shuaipengju/distractor_code_coattention/data/processed.glove.enc.pt',
                       help="""If a valid path is specified, then this will load
                       pretrained word embeddings on the encoder side.
                       See README for specific formatting instructions.""")
    group.add_argument('-pre_word_vecs_dec',default = '/data/home/shuaipengju/distractor_code_coattention/data/processed.glove.dec.pt',
                       help="""If a valid path is specified, then this will load
    ...
    group.add_argument('-valid_steps', type=int, default=3000,
    ...
    group.add_argument('-max_generator_batches', type=int, default=32,
                       help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument('-train_steps', type=int, default=45000,
    ...
    group.add_argument('-learning_rate_decay', type=float, default=0.5,
                       ...
                       start_decay_steps""")
    group.add_argument('-start_decay_steps', type=int, default=30001,
                       help="""Start decaying every decay_steps after
                       start_decay_steps""")
    group.add_argument('-decay_steps', type=int, default=3000,
...
def translate_opts(parser):
    ...
    group.add_argument('-model', dest='models', metavar='MODEL',
                       nargs='+', type=str, default=['/data/home/shuaipengju/distractor_code_coattention/data/model/__step_45000.pt'], #required=True,
    ...
    group.add_argument('-data_type',
                       ...
                       help="""concat: p <q> q <a> a <q> q <a> a <a> current_answer,
                                        ...
                                        """)
    group.add_argument('-data', default = '/data/home/shuaipengju/distractor_code_coattention/data/race_test.json',#required=True,
                       help="""Path prefix to the "-test.json" 
                       file path from preprocess.py""")

    group.add_argument('-output', default='/data/home/shuaipengju/distractor_code_coattention/data/pred/__step_45000.txt',
    ...
    group.add_argument('-fast', action="store_true",
                       ...
                       supported!)""")
    group.add_argument('-beam_size', type=int, default=30,
                       help='Beam size')
    ...
    group.add_argument('-n_best', type=int, default=30,
